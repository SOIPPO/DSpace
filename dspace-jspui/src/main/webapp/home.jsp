...
<%
    ...
    DCInputsReader reader = new DCInputsReader(I18nUtil.getInputFormsFileName(new Locale(sessionLocale.getLanguage())));
                        ...
                        <div class="carousel-inner">
                            ...
                            <div style="padding-bottom: 50px; min-height: 200px;" class="item <%= first?"active":""%>">
                                <div style="padding-left: 80px; padding-right: 80px; display: inline-block;"><%= StringUtils.abbreviate(displayTitle, 400) %>
                                    ...
                                    <p><%= StringUtils.abbreviate(displayAbstract, 500) %>
                                    </p>
                                </div>
                            </div>
                            <%
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            ...
                            <h4 class="list-group-item-heading"><a
                                    href="<%= request.getContextPath() %>/handle/<%= communities[i].getHandle() %>"><%= communities[i].getMetadata("name") %>
                            </a>
                                <%
                            ...
                            <p><%= communities[i].getMetadata("short_description") %>
                            </p>
                        </div>
                    </div>
                    <%
